...
data class MusicalEventModel(
    ...
    val artist: String
) : AbstractEventModel<MusicalCategory>(id, EventType.Musical, title, description, creator, capacity, enrolled, price, isPrivate, category, startDate, endDate, locationModel)
